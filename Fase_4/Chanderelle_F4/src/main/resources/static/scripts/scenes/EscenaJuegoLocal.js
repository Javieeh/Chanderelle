...
class EscenaJuegoLocal extends Phaser.Scene {
    ...
    initialize() {
        Phaser.Scene.call(this, { key: 'GameLocalScene' });
    }
    ...
    update() {
        ...
        if (this.cursors.left.isDown) {
            ...
            this.MovimientoIzqP1();
        }
        else if (this.cursors.right.isDown) {

            this.MovimientoDchP1();
        }
        else {
            this.IdleP1();
        }
        ...
        if ((this.keyA).isDown) {
            this.MovimientoIzqP2();
        }
        else if ((this.keyD).isDown) {
            this.MovimientoDchP2();
        }
        else {
            this.IdleP2();
        }
